        ...
        <Grid container sx={{ ...globalStyles.gridContainer }} >
          ...
          <Grid md={5} xs={12} item display={'flex'} alignItems={'center'} justifyContent='space-evenly' >
            <Box>
              ...
              <a href="sd" style={{ ...globalStyles.links }} >zeeshanmehdi253@gmail.com</a>
            </Box>
            <Box>
...
const navbarOptions = [
  ...
  { label: 'Details', "path": "/ProductDetails" },
  { label: 'Cart', "path": "./shopingCart" },
  { label: 'CheckOut', "path": "./checkOutPage" },
  { label: 'Orders', "path": "./orderCompleted" },
]
