  ...
  switch (action.type) {
    case productActionTypes.ADD_PRODUCT:
      ...
      if (oldPaginations[lastPaginationPage]) {
        // if user already clicked on last page
    ...
    case productActionTypes.EDIT_PRODUCT:
      ...
      newProductsForEditProduct[action.payload.productIndex] =
    ...
    case productActionTypes.DELETE_PRODUCT:
      ...
      let productsForDeletedRecordPage = state.products.slice(
        state.paginationArray[action.payload.page].startIndex,
        state.paginationArray[action.payload.page].endIndex
      );
      const deletedRecordIndex = productsForDeletedRecordPage.findIndex(
    ...
    case productActionTypes.PRODUCTS_LOADED:
      ...
      if (action.payload.products) {
        let newPageRecord = {
          ...
          endIndex: updatedProductsArray.length,
        };
