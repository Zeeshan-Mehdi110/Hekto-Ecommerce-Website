...
const dropdownList = [
  ...
  },
  {
    ...
    icon: <ListIcon />,
    items: [
      { to: "/admin/users/add", text: "Add user", icon: <AddCircleOutline /> },
      { to: "/admin/users", text: "Users", icon: <GroupIcon /> },
    ],
  },
  {
    title: "Categories",
    ...
    items: [
      ...
      { to: "/admin/categories", text: "Categories", icon: <GroupIcon /> },
    ],
  },
];
...
export default function Sidebar() {
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      <AppBar
        position="fixed"
        sx={{ background: "var(--purple)", fontFamily: "var(--josefin)" }}
        open={open}
      >
        <Toolbar>
          <IconButton
          ...
          <IconButton
            ...
            sx={{
              marginLeft: "auto",
              marginRight: "30px",
              "&:hover .sinupBox": { visibility: "visible" },
            }}
            // onClick={handleMenu}
            color="inherit"
          >
