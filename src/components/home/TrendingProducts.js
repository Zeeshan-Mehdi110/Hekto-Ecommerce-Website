...
import discountProduct1 from '../../static/images/discountProduct/discountProduct1.png'
import discountProduct2 from '../../static/images/discountProduct/discountProduct2.png'
import discountProduct3 from '../../static/images/discountProduct/discountProduct3.png'
import discountProduct4 from '../../static/images/discountProduct/discountProduct4.png'
import discountProduct5 from '../../static/images/discountProduct/discountProduct5.png'
    ...
    return (
        <Box mt={9}>
            ...
            <Box mt={5} textAlign="center">
                <Typography variant="h1" sx={{ ...globalStyles.mainHeading, color: '#151875', fontSize: !isMobile ? '42px' : '32px' }}>Trending Products</Typography>
            </Box>
